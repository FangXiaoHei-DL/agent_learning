...
- [第3章 工具调用（Tool Use / Function Calling）](./chapter_tools/README.md)
  - [3.1 为什么 Agent 需要工具？](./chapter_tools/01_why_tools.md)
  - [3.2 Function Calling 机制](./chapter_tools/02_function_calling.md)
  - [3.3 自定义工具的设计与实现](./chapter_tools/03_custom_tools.md)
  - [3.4 工具描述的编写技巧](./chapter_tools/04_tool_description.md)
  - [3.5 实战：搜索引擎 + 计算器 Agent](./chapter_tools/05_practice_search_calc.md)
  - [3.6 论文解读：工具学习前沿进展](./chapter_tools/06_paper_readings.md)

- [第4章 记忆系统（Memory）](./chapter_memory/README.md)
  - [4.1 为什么 Agent 需要记忆？](./chapter_memory/01_why_memory.md)
  - [4.2 短期记忆：对话历史管理](./chapter_memory/02_short_term_memory.md)
  - [4.3 长期记忆：向量数据库与检索](./chapter_memory/03_long_term_memory.md)
...
- [第5章 规划与推理（Planning & Reasoning）](./chapter_planning/README.md)
  ...
  - [5.2 ReAct：推理 + 行动框架](./chapter_planning/02_react_framework.md)
...
- [第6章 检索增强生成（RAG）](./chapter_rag/README.md)
  ...
  - [6.2 文档加载与文本分割](./chapter_rag/02_document_loading.md)
  - [6.3 向量嵌入与向量数据库](./chapter_rag/03_embeddings_vectordb.md)
...
- [第7章 上下文工程](./chapter_context_engineering/README.md)
  ...
  - [7.2 上下文窗口管理与注意力预算](./chapter_context_engineering/02_context_window.md)
  - [7.3 长时程任务的上下文策略](./chapter_context_engineering/03_long_horizon.md)
  - [7.4 实战：构建上下文管理器](./chapter_context_engineering/04_practice_context_builder.md)
  - [7.5 上下文工程前沿进展](./chapter_context_engineering/05_latest_advances.md)

- [第8章 Harness Engineering：驾驭 Agent 的系统工程](./chapter_harness/README.md)
  - [8.1 什么是 Harness Engineering？](./chapter_harness/01_what_is_harness.md)
  - [8.2 六大工程支柱](./chapter_harness/02_six_pillars.md)
  - [8.3 AGENTS.md / CLAUDE.md：Agent 宪法写作指南](./chapter_harness/03_agents_md.md)
  - [8.4 生产级案例：OpenAI、LangChain、Stripe](./chapter_harness/04_production_cases.md)
  - [8.5 实战：构建你的第一个 Harness 系统](./chapter_harness/05_practice_harness_builder.md)
  - [8.6 结构化输出：保障 JSON 可靠性的工程实践](./chapter_harness/06_structured_output.md)
...
- [第9章 Skill System](./chapter_skill/README.md)
  ...
  - [9.8 Skills圣经：Superpowers工程实践指南](./chapter_skill/08_superpowers_guide.md)
...
- [第10章 Agentic-RL：智能体强化学习训练](./chapter_agentic_rl/README.md)
  ...
  - [10.2b 分布式训练基础：DP / TP / PP / SP / ZeRO](./chapter_agentic_rl/02b_distributed_training.md)
...
- [第14章 Claude Code 深度解析：从使用到源码](./chapter_claude_code/README.md)
  - [14.1 认识 Claude Code：从零到上手](./chapter_claude_code/01_introduction.md)
  - [14.2 核心架构深度解析](./chapter_claude_code/02_architecture.md)
  - [14.3 源码解密：System Prompt 与权限工程](./chapter_claude_code/03_source_code_analysis.md)
  - [14.4 高级用法：MCP、Hooks 与 Skills](./chapter_claude_code/04_advanced_usage.md)
  - [14.5 生产实践：在团队中用好 Claude Code](./chapter_claude_code/05_best_practices.md)
...
- [第15章 多 Agent 协作](./chapter_multi_agent/README.md)
  - [15.1 单 Agent 的局限性](./chapter_multi_agent/01_single_agent_limits.md)
  - [15.2 多 Agent 通信模式](./chapter_multi_agent/02_communication_patterns.md)
  - [15.3 角色分工与任务分配](./chapter_multi_agent/03_role_assignment.md)
  - [15.4 Supervisor 模式 vs. 去中心化模式](./chapter_multi_agent/04_supervisor_vs_decentralized.md)
  - [15.5 实战：多 Agent 软件开发团队](./chapter_multi_agent/05_practice_dev_team.md)
  - [15.6 论文解读：多 Agent 系统前沿研究](./chapter_multi_agent/06_paper_readings.md)

- [第16章 Agent 通信协议](./chapter_protocol/README.md)
  - [16.1 MCP（Model Context Protocol）详解](./chapter_protocol/01_mcp_protocol.md)
  - [16.2 A2A（Agent-to-Agent）协议](./chapter_protocol/02_a2a_protocol.md)
  - [16.3 ANP（Agent Network Protocol）协议](./chapter_protocol/03_anp_protocol.md)
  - [16.4 Agent 间的消息传递与状态共享](./chapter_protocol/04_message_passing.md)
  - [16.5 实战：基于 MCP 的工具集成](./chapter_protocol/05_practice_mcp_integration.md)
...
- [第17章 Agent 的评估与优化](./chapter_evaluation/README.md)
  - [17.1 如何评估 Agent 的表现？](./chapter_evaluation/01_evaluation_methods.md)
  - [17.2 基准测试与评估指标](./chapter_evaluation/02_benchmarks.md)
...
- [第18章 安全与可靠性](./chapter_security/README.md)
  ...
  - [18.2 幻觉问题与事实性保障](./chapter_security/02_hallucination.md)
  - [18.3 权限控制与沙箱隔离](./chapter_security/03_permission_sandbox.md)
...
- [第19章 部署与生产化](./chapter_deployment/README.md)
  ...
  - [19.2 API 服务化：FastAPI / Flask 封装](./chapter_deployment/02_api_service.md)
...
- [第20章 项目实战：AI 编程助手](./chapter_coding_agent/README.md)
  - [20.1 项目架构设计](./chapter_coding_agent/01_architecture.md)
  - [20.2 代码理解与分析能力](./chapter_coding_agent/02_code_understanding.md)
  - [20.3 代码生成与修改能力](./chapter_coding_agent/03_code_generation.md)
  - [20.4 测试生成与 Bug 修复](./chapter_coding_agent/04_testing_debugging.md)
  - [20.5 完整项目实现](./chapter_coding_agent/05_full_implementation.md)

- [第21章 项目实战：智能数据分析 Agent](./chapter_data_agent/README.md)
  - [21.1 需求分析与架构设计](./chapter_data_agent/01_requirements.md)
  - [21.2 数据连接与查询](./chapter_data_agent/02_data_connection.md)
  - [21.3 自动化分析与可视化](./chapter_data_agent/03_analysis_visualization.md)
  - [21.4 报告生成与导出](./chapter_data_agent/04_report_generation.md)
  - [21.5 完整项目实现](./chapter_data_agent/05_full_implementation.md)

- [第22章 项目实战：多模态 Agent](./chapter_multimodal/README.md)
  - [22.1 多模态能力概述](./chapter_multimodal/01_multimodal_overview.md)
...
- [附录 F：开发环境搭建](./chapter_setup/README.md)
  - [F.1 Python 环境与依赖管理](./chapter_setup/01_python_setup.md)
