...
### [工具调用持续学习的轨迹监督策略](https://arxiv.org/abs/2605.09734)

**发表**：2026 年 5 月 10 日 | [arXiv:2605.09734](https://arxiv.org/abs/2605.09734)

**核心贡献**：本文研究 LLM 在持续学习新 API 领域时保留工具使用轨迹的价值。使用 QLoRA 微调 Llama 3.1 8B，在 API-Bank 数据集四个顺序域上对比"保留完整 API 请求/响应轨迹"与"仅保留结果"两种训练策略。结果表明保留轨迹策略在完整 API 调用准确率上达 56.9%，相比去除轨迹的基线提升 **17.7 个百分点**，同时在持续学习中有效缓解旧领域工具调用遗忘问题。
